...
PropertiesPanel.prototype._init = function(config) {
  ...
  eventBus.on([
   ...
   // console.log('propertiesPanel.changed或者propertiesPanel.resized')
  ...
  eventBus.on('elementTemplates.changed', function() {
    var current = self._current;
    var element = current && current.element;
    //console.log('elementTemplates.changed')
    if (element) {
      self.update(element);
    }
  });
...
PropertiesPanel.prototype._updateActivation = function(current) {
  ...
  function updateLabel(element, selector, text) {
    ...
    //console.log(document.getElementsByClassName('data-list-entry-container').length)
  }
...
PropertiesPanel.prototype._createPanel = function(element, tabs) {
  ...
  forEach(tabs, function(tab, tabIndex) {
    ...
    if(tab.id!='general'&&tab.id!='extensionElements'){
       var tabLinkNode = domify('<li class="bpp-properties-tab-link" style="display:none">' +
          '<a href data-tab-target="' + tab.id + '">' + tab.label + '</a>' +
        '</li>');
     }else{
       var tabLinkNode = domify('<li class="bpp-properties-tab-link">' +
          '<a href data-tab-target="' + tab.id + '">' + tab.label + '</a>' +
        '</li>');
     }
    ...
    forEach(groups, function(group) {
      ...
      if(group.id!=='general'&&group.id!='extensionElements-properties'&&group.id!='details')
      //if(group.id=='externalTaskConfiguration'||group.id=='jobConfiguration'||group.id=='documentation'||group.id=='historyConfiguration'||group.id=="details"||group.id=='async')
      {
        var groupNode = domify('<div class="bpp-properties-group" style="display:none" data-group="' + group.id + '">' +
  ...
  // console.log(JSON.stringify(tabBarNode))
  // console.log(JSON.stringify(tabContainerNode))
